                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('product.suspend', $value->plan_id ??'') }}"class="btn btn-success"
                                                    type="button" id="dejangoshow">Active</a>
                                                @elseif ($value->status == 1)
                                                <a href="{{ route('product.suspend', $value->plan_id ??'') }}"class="btn btn-danger"
                                                    type="button" id="dejangoshow">OFF</a>
                                                @endif
                                            </td>
                                            <td>
                                                @if ($value->status == 0)
                                                <a href="{{ route('plans.edit', $value->id ??'') }}"class="btn btn-primary"
                                                    type="button" id="dejangoshow">Edit</a>
                                                @else
