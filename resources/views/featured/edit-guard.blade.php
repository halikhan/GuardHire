                                        ...
                                        <select class="serviceDropdown form-control" aria-label="Default select example" id="location"
                                            ...
                                            @foreach ($getlocation as $value)
                                                <option value="{{ $value->id }}"
                                                    {{ $value->id == $edit_data->featured_guardjobs->location_id ? 'selected' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="select">
                                            <select class="serviceDropdown form-control" aria-label="Default select example"
                                                ...
                                                <option value="{{ $value->id }}"
                                                    {{ $value->id == $edit_data->featured_guardjobs->job_type ? 'selected' : '' }}>
                                                    {{ $value->name }}</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="select">
                                                <select class="form-control" aria-label="Default select example"
                                                   ...
                                                   <option value="{{ $value->id }}"
                                                    {{ $value->id == $edit_data->featured_guardjobs->services ? 'selected' : '' }}>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <div class="col-sm-12">
                                            <input name="companyname" value="{{ $edit_data->featured_guardjobs->companyname ??''}}" type="text" class="form-control"
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <div class="col-sm-12">
                                            <input type="text"value="{{ $edit_data->featured_guardjobs->job_duration ??''}}"  class="form-control" placeholder="Job Duration"
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <div class="col-sm-12">
                                            <input type="text"value="{{ $edit_data->featured_guardjobs->per_hour_rate ??''}}"  class="form-control" placeholder="Per Hour Rate"
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <div class="col-sm-12">
                                            <textarea name="description" type="text" class="form-control" placeholder="Type Here...">{{ $edit_data->featured_guardjobs->description ??''}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
