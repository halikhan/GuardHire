    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="profileField">
            ...
            <input name="contact" type="text" min="0" class="inputName"
                ...
                {{-- <input name="userlocation" type="text" class="inputName"
                    placeholder="Location"value="{{ Auth::user()->userlocation ?? '' }}"> --}}
                    <div class="select">
                        <select class="serviceDropdown" aria-label="Default select example"
                            id="location" name="userlocation">
                ...
                <div class="select">
                    <select class="serviceDropdown" aria-label="Default select example" id="services"
                        ...
                        @foreach ($getservice as $value)
                            <option value="{{ $value->id }}" {{ $value->id == Auth::user()->services ? 'selected' : '' }}>{{ $value->service }}</option>
                        @endforeach
                    </select>
                </div>
