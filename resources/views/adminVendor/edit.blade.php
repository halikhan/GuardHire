                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="container mt-4 CSTM cstm-tab-dashboard">
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    {{-- <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill"
                                        data-bs-target="#v-pills-profile" type="button" role="tab"
                                        aria-controls="v-pills-profile" aria-selected="true">Password</button> --}}
                                </div>
                            </nav>
                        </div>
                        ...
                        <div class="gallery-section">
                                <div class="container">
                                    <form action="{{ route('adminVendor-Update', $edit_data->id) }}" enctype="multipart/form-data" method="post">
                                        @csrf
                                    <div class="tab-content" id="v-pills-tabContent">

                                        {{-- ==== user Profile tab=== --}}

                                        <div class="tab-pane fade active show" id="v-user-profile" role="tabpanel"
                                                ...
                                                <div class="col">
                                                    <div class="mb-3">
                                                        ...
                                                        @if ($edit_data->image != null)
                                                            <img src="{{ asset('storage/uploads/cms/' . $edit_data->image) }}"
                                                ...
                                                <div class="col">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="name" class="form-control btn-square"
                                                            ...
                                                            value="{{ $edit_data->name }}" placeholder="Name">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="email" class="form-control btn-square"
                                                            ...
                                                            id="exampleFormControlInput10" type="email"
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="phonebride" class="form-control btn-square"
                                                            type="tel" placeholder="Phone No." name="contact"
                                                            maxlength="14" value="{{ $edit_data->contact }}"
                                                ...
                                                <div class="col">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="password" class="form-control btn-square"
                                                            value="" id="exampleFormControlInput10" type="password"
                                                            placeholder="Password">
                                                        <input type="hidden" value="{{ $edit_data->password }}"
                                                            name="prevpassword">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        {{-- <div class="tab-pane fade " id="v-pills-review" role="tabpanel"
                                           ...
                                           <div class="row">
                                               <div class="form-group col-md-12">
                                                   <label for="exampleFormControlInput10">Select Cities of Vendor.*</label>
                                               </div>
                                           </div>
                                           <div class="row">
                                               <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="bussinessCategory" class="form-select"
                                                        size="1">
                                        ...
                                        <div class="tab-pane fade" id="v-pills-home" role="tabpanel"
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3 row">
                                                        <label for="inputImage">Upload Vendor Images.*</label>
                                                        <h6 class="mutipleimages">Please select multiple images at once.*
                                                        </h6>

                                                        <input type="file" name="wedding_image[]"
                                                            class="myfrm form-control" id="wedding_images" multiple
                                                            onchange="image_select()">
                                                        {{-- @foreach (json_decode($getUserWeddingimages->image) as $image) --}}
                                                        <input name="old_wedding_image" class="form-control"
                                                            type="hidden" value="{{ $getvendorimages->image ?? '' }}">
                                        ...
                                        <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h4 class="pt-5">Vendor reviews</h4>
                                                    <p></p>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                        ...
                                                        @if ($getvendorabout->image2 ?? '')
                                                        <a href="{{ asset('storage/uploads/cms/' . $getvendorabout->image2 ?? '') }}"
                                                            download="">
                                                        <button type="button"  class="sign-btn">Download
                                                            reviews</button>
                                                        </a>
                                                        @else
                                                            No reviews file found
                                                        @endif
                                                </div>
                                            </div>
                                            <br />
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="file" name="image2" class="form-control"
                                                        id="inputImage" placeholder="Name">
                                                </div>
                                            </div>
                                            <br />
                                            <div class="row" align="left">
                                                <div class="form-group col-md-12" >
                                                    <button class="btn btn-primary mailregister"
                                                        type="submit">Update Vendor</button>
                                                </div>
                                            </div>
                                        </div>
