...
@section('content')
    ...
    <div class="for-content-tabs">
        <h2 class="top-tabt-heading">Edit Wedding</h2>
        <br><br>
        <input type="hidden" value="{{ csrf_token() }}" name="_token" id="token">
        <form action="{{ route('user_wedding_update', $edit_data->slug) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="hidden" name="old_wedding_image" id="old_user_image"
                ...
                <div class="container mt-3 w-100">
                    <div class="row">
                        <div class="col-md-12">
                            <input type="file" name="wedding_image[]" class="myfrm form-control" id="wedding_images"
                ...
                <div class=" form-group col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input name="groom_last_name"
                                value="{{ $edit_data->groom_last_name }}"class="form-control btn-square"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input name="bride_last_name"
                                value="{{ $edit_data->bride_last_name }}"class="form-control btn-square"
                                id="exampleFormControlInput10" type="text" placeholder="Last Name">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input name="date" id="txt-appoint_date"
                                value="{{ $edit_data->date }}"class="form-control btn-square"
