...
@section('content')
    ...
    <div class="for-content-tabs">
        <h2 class="top-tabt-heading">Wedding Management</h2>
        <br><br>
                        ...
                        <td>
                            <button class="btn delete-submit-cstmbtn" type="button"
                                data-original-title="btn btn-danger btn-xs" title=""><a
                                    href="{{ route('user_wedding_destroy', $value->slug) }}" id="delete"><i
                                        class="fa fa-trash" aria-hidden="true"></i></a></button>

                            <button class="btn edit-submit-cstmbtn" type="button"
                                data-original-title="btn btn-danger btn-xs" title=""> <a
                                    href="{{ route('user_wedding_edit', $value->slug) }}"><i class="fa fa-pencil-square-o"
                            ...
                            <button class="btn show-submit-cstmbtn" type="button"
                                data-original-title="btn btn-primary btn-xs" title=""> <a
                                    href="{{ route('user_wedding_show', $value->slug) }}"><i class="fa fa-eye"
                                        aria-hidden="true"></i></a></button>
                        </td>
                    </tr>
                @endforeach
