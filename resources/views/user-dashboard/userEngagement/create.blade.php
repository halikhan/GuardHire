...
@section('content')
    ...
    <div class="for-content-tabs">
        <h2 class="top-tabt-heading">Create Engagement</h2>
        <br><br>
        <input type="hidden" value="{{ csrf_token() }}" name="_token" id="token">
        <form action="{{ route('user_engagement_store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="card shadow-sm w-100">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="file" name="image" id="selectbannerimage" class="myfrm form-control">
                        </div>
                    </div>
                    {{-- <div class="row">
                <div class="form-group col-md-12 field">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="file" name="engagement_image[]" style="width: 100%;" id="wedding_images"
                                multiple onchange="image_select()">
                            {{-- onchange="image_select(this)" onclick="this.value=null;"> --}}
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input name="groom" class="form-control btn-square clcik" value="{{ old('groom') }}"
                        id="image_submit" type="text" placeholder="First Name">
                </div>
                <div class="form-group col-md-6">
                    <label for="exampleFormControlInput10">Groom Last Name.*</label>
                    <input name="groom_last_name" class="form-control btn-square clcik" value="{{ old('groom_last_name') }}"
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input name="bride" class="form-control btn-square clcik" value="{{ old('bride') }}"
                        id="exampleFormControlInput10" type="text" placeholder="First Name">
                </div>
                <div class="form-group col-md-6">
                    <label for="exampleFormControlInput10">Bride Last Name.*</label>
                    <input name="bride_last_name" class="form-control btn-square clcik" value="{{ old('bride_last_name') }}"
                        id="exampleFormControlInput10" type="text" placeholder="Last Name">
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input name="location" class="form-control btn-square clcik" value="{{ old('location') }}"
                        id="ship-address" type="text" placeholder="location">
                </div>
                <div class="form-group col-md-6">
                    <label for="exampleFormControlInput10">Wedding Date.*</label>
                    <input name="date" id="txt-appoint_date" class="form-control btn-square" clcik"
                        value="{{ old('date') }}" id="exampleFormControlInput10" type="date">
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <textarea name="content" id="editor" class="ckeditor form-control btn-square clcik" value="{{ old('content') }}"
    ...
    {{-- <script>
                    $(document).ready(function(){
                        $('#image_submit').click(function(){
                            var num_of_images = $("#imge_count")[0].files.length;

                            if(num_of_images > 5){
                                toastr.error('you can only upload 5 images');
