...
@section('content')
    ...
    <script>
        const stripe = Stripe(
            "pk_test_51KhLF7J5CNuTNvMYV0zjTWfpbOzEvbNtT8dO7BN0aLcUMGygqlUDWgXEA2BnUg8sGRCgYVD20cugdGJ2QC8fKfvm00IPz1Ktis"
            );
...
<script>
    ...
    const stripe = Stripe('pk_test_51LGnnGEzIQiMqj2YasCnBdu2mFCKgz8Xr2rtPdOUQoDtv0iNLu4SqMOFUVWrM9xyfV1qjPHTe7lCW2YOkq99KQ5900MQYeIBfc');
    const btn = document.getElementById('checkout-button')
    btn.addEventListener('click', function(e){
        e.preventDefault();
        stripe.redirectToCheckout({
