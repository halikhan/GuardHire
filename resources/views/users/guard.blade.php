                            ...
                            <table class="display" id="basic-1">
                                ...
                                <tbody>
                                    @foreach ($show_data  as $collection)
                                        @foreach ($collection->get_guardjobs  as $key=> $studentData )
                                        <tr>
                                        <td>{{ $key+1 }}</td>
                                        {{-- <td>
                                        ...
                                        <td> {{ $studentData->guard_service->service ??''}}</td>
                                        <td>{{ $studentData->guard_location->location ??''}}</td>
                                        <td> ${{ $studentData->per_hour_rate ??''}}</td>
