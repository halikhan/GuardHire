...
<form id="upload-form" method="post" action="<?php echo e(route('store.guard.companies.rating')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row">
...
<?php /**PATH C:\xampp\htdocs\guard_hire\resources\views/frontend/client_dashboard/hired-companies-rating-modal.blade.php ENDPATH**/ ?>