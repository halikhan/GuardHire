        ...
        <div class="profileField">
            <div class="connectPhone">
                ...
                <a href="tel:111-222-333" data-bs-dismiss="modal">
                    <p><?php echo e($clientjob->client_postjob_details->contact ??''); ?> </p>
                </a>
            </div>
            ...
            <div class="connectChat">
                ...
                ?>
                <a href="<?php echo e(url('/chatify',$id)); ?>"><button class="blueActive chatWidth">Chat</button></a>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\guard_hire\resources\views/frontend/guard_dashboard/client-comment-modal.blade.php ENDPATH**/ ?>