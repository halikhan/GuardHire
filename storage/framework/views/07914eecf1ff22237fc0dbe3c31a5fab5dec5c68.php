            ...
            <div class="row">
                <div class="offset-lg-3 col-lg-6">
                    <div class="browseServiceHeaderHeading">
                        ...
                        <a href="<?php echo e(route('browse.quotes')); ?>" align="center"><button type="button" class="exploreButton" >Back</button></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-12">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="browseServiceHeaderHeading">
                        <a href="<?php echo e(route('browse.quotes')); ?>" align="center"><button type="button" class="exploreButton">Go Back</button></a>
                    </div>
                    <?php endif; ?>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\guard_hire\resources\views/frontend/browse-requests-serach-results.blade.php ENDPATH**/ ?>