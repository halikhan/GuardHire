...
<?php $__env->startSection('content'); ?>
                ...
                <div class="row">
                    <div class="offset-lg-3 col-lg-6">
                        <div class="browseServiceHeaderHeading">
                            <h2><?php echo e($sectionBrowseServices->title); ?></h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <?php $__currentLoopData = $getBrowseServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="securityRatingDetail">
                                                <div class="col-lg-4 col-md-4">
                                                    <div class="securityStarting">
                                                        <h6>Budget: $<?php echo e($value->per_hour_rate ?? '0.00'); ?></h6>
    ...
    <script type="text/javascript">
            function saveToWishlist(id, guard_job_details_id) {
                $.ajax({
                    headers: {
                    ...
                    data: {
                        id: id,
                        guard_job_details_id: guard_job_details_id
                    },
                    success: function(response) {
                        if (response.status === 'added') {
                            // Update heart icon to red filled heart
                            $('#wishlistIcon-' + id).removeClass('fa-heart-o').addClass('fa-heart');
                            ...
                            $('#wishlistIcon-' + id).removeClass('fa-heart').addClass('fa-heart-o');
                            toastr.info('Item removed from your wishlist!');
                            setTimeout(function () {
                                    location.reload();
                                }, 1000);
                            // Remove the local storage item when an item is removed
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\guard_hire\resources\views/frontend/browse-services.blade.php ENDPATH**/ ?>