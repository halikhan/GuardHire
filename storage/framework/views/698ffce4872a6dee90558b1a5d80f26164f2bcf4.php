    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="profileField">
                ...
                <label>Email</label>
                <input type="email" name="email" class="inputName" placeholder="email@xyz.com">
            </div>
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="profileField">
...
<?php /**PATH C:\xampp\htdocs\guard_hire\resources\views/frontend/client_dashboard/client-help.blade.php ENDPATH**/ ?>