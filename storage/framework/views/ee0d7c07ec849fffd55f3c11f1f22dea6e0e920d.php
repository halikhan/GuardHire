...
<div class="messenger">
    ...
    <div class="messenger-listView <?php echo e(!!$id ? 'conversation-active' : ''); ?>">
        ...
        <div class="m-header">
            <nav>
                <a href="<?php echo e(route('home')); ?>"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">Home</span> </a>
        ...
        <div class="m-header m-header-messaging">
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                ...
                <nav class="m-header-right">
                    ...
                    <a href="<?php echo e(route('guard.dashboard')); ?>">
                    ...
                    <a class="link_header" href="<?php echo e(route('user.logout')); ?>">
                        Logout
...
<?php /**PATH C:\xampp\htdocs\guard_hire\resources\views/vendor/Chatify/pages/app.blade.php ENDPATH**/ ?>