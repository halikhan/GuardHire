                        ...
                        <div class="table-responsive product-table">
                            ...
                            <table class="display" id="basic-1">
                                <tbody>
                                    <tr>
                                        <th>Package</th>
                                        <td><?php echo e($guardPaymentDetail->package_title ??'No data found'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Type</th>
                                        <td><?php echo e($guardPaymentDetail->package_type ??'No data found'); ?> Credits/ $<?php echo e($guardPaymentDetail->package_amount ??'No data found'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Amount</th>
                                        <td>$<?php echo e($guardPaymentDetail->package_amount ??'No data found'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>New Message Pts</th>
                                        <td><?php echo e($guardPaymentDetail->msg_points ??'No data found'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Service Listing Pts</th>
                                        <td><?php echo e($guardPaymentDetail->listing_points ??'No data found'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Total Credit</th>
                                        <td><?php echo e($totalCreditsPurchased ??'No data found'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Used Message Pts</th>
                                        <td><?php echo e($totalCreditPoints ??'No data found'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Used Service Listing Pts</th>
                                        <td><?php echo e($listingCount ??'No data found'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Remaining Credits</th>
                                        <td><?php echo e($remainingCredits ??'No data found'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Gift Points for User</th>
                                        <td>
                                            <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
                                            <form class="form theme-form"id="" action="<?php echo e(route('user.gift.points')); ?>"
                                            enctype="multipart/form-data" method="post">
                                            <?php echo csrf_field(); ?>
                                                <?php echo csrf_field(); ?>
                                                <input type="number" name="gifted_points" class="inputField">
                                                <input type="hidden" name="user_id" value="<?php echo e($guardPaymentDetail->user_id); ?>">
                                                <input type="hidden" name="package_id" value="<?php echo e($guardPaymentDetail->id); ?>">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\guard_hire\resources\views/users/show_guard_package.blade.php ENDPATH**/ ?>