                ...
                <div class="row">
                    <div class="offset-lg-3 col-lg-6">
                        <div class="browseServiceHeaderHeading">
                            ...
                            <a href="<?php echo e(route('browse.companies')); ?>" align="center"><button type="button"
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $serachresult; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="row browseServiceCard">
                                ...
                                <div class="col-lg-7 wow animate__animated animate__fadeInRight" data-wow-duration="1.2s">
                                    <div class="groupSecurityDetail">
                                        <h2><?php echo e($value->companyname ?? 'Company Name Not Found'); ?></h2>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\guard_hire\resources\views/frontend/companies-serach-results.blade.php ENDPATH**/ ?>